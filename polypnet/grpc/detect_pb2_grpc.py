...
class PolypDetectionService(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def BatchPolypDetect(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.vdsense.polypnet.proto.PolypDetectionService/BatchPolypDetect',
            detect__pb2.BatchPolypDetectionRequest.SerializeToString,
            detect__pb2.BatchPolypDetectionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def StreamPolypDetect(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/com.vdsense.polypnet.proto.PolypDetectionService/StreamPolypDetect',
            detect__pb2.PolypDetectionRequest.SerializeToString,
            detect__pb2.PolypDetectionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
